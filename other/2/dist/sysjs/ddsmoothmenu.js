...
arrowimages: {down:['downarrowclass', '/temp/skin1/images/down.gif', 23], right:['rightarrowclass', '/temp/skin1/images/leftmenu_icon.gif']},
...
buildmenu:function($, setting){
	...
	$headers.each(function(i){ //loop through each LI header
		var $curobj=$(this).css({zIndex: 100-i}).attr('id','chcss');; //reference current LI header
