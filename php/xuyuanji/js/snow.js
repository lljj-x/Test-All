...
(function($) {
	...
	function i(a) {
		...
		this.parent = document.getElementById("tree");
		this.createEl(this.parent, a);
		this.size = Math.random() * 10 + document.body.offsetWidth / 50;
	...
	i.prototype = {
		createEl: function(a, b) {
			...
			// this.el.setAttribute("src", b + "/images/color/section_1/star" + Math.floor(Math.random() * 4) + ".png");
            this.el.setAttribute("src", "images/snow.png");
