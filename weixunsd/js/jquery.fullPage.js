    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        FP.weixunAddSlide = function(afterOnElm,afterData,thisIndex){
            ...
            $thisParent.children().css({
                width: 100/numSlides + '%'
            });
            //go to slide
            for(var i=0; i< numSlides -1; i++){
                $slides_wrapper.siblings("." + SLIDES_NAV).find('ul').append('<li><a href="#"><span></span></a></li>');
            }
            ...
            if (numSlides > 0) {
                ...
                **/
                ...
                if(options.controlArrows){
                    createSlideArrows($(this),numSlides);
                }
        ...
        */
        function createSlideArrows(section,numSlides){
            ...
            // liu.jun
            checkSlideArrow(section.find("." + SLIDES_ARROW),numSlides);
        }

        // liu.jun
        function checkSlideArrow(jqArrow,numSlides){
            if(options.controlArrows && numSlides <= 1){
                jqArrow.addClass("display-none");
            }else{
                jqArrow.removeClass("display-none");
            }
        }
        ...
        */
        function addSlidesNavigation(section, numSlides){
            ...
            checkSlideNav(nav,numSlides);
        }


        // by liu.jun 如果只有一个不显示小边导航点
        function checkSlideNav(jqNav,numSlides){
            if(options.slidesNavigation){
                if(numSlides===1){
                    // addClass
                    jqNav.addClass("display-none");
                }else{
                    jqNav.removeClass("display-none");
                }
            }
            jqNav.css('margin-left', '-' + (jqNav.width()/2) + 'px');
        }
